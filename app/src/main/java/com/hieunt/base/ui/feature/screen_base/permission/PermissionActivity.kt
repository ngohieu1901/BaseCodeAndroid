package com.hieunt.base.ui.feature.screen_base.permission
...
import com.hieunt.base.ui.components.dialogs.WarningPermissionDialogFragment
    ...
    override fun initView() {
        ...
        binding.ivSwitch.tap {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                if (permissionUtils.canShowAllListPermissionDialogSystem(Default.STORAGE_PERMISSION_API_SMALLER_30)) {
                    binding.ivSwitch.isChecked = false
                    WarningPermissionDialogFragment {
                        goToSetting(this)
                    }.show(supportFragmentManager, javaClass.name)
                } else {
                    callStoragePermission.launch(Default.STORAGE_PERMISSION_API_SMALLER_30)
                }
            }
        }
